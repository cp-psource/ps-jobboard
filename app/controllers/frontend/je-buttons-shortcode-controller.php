...
class JE_Buttons_Shortcode_Controller extends IG_Request
{
    ...
    function expert_add($atts)
    {
        ...
        extract(shortcode_atts(array(
            'text' => __('Neues Expertenprofil', 'psjb'),

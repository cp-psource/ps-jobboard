...
class JE_Expert_Add_Widget_Controller extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Biete Deine Fähigkeiten an', 'psjb') : $instance['title'], $instance, $this->id_base);
        echo $before_widget;
        if ($title) {
                            ...
                            <div class="well well-sm">
                                <form class="search-form" method="GET"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-12">
                                            <label><?php _e('Nachname', 'psjb') ?></label>
                                        ...
                                        <div class="col-md-12">
                                            <button class="btn btn-primary btn-sm pull-right"
                                                    type="submit"><?php _e('Biete Deine Fähigkeiten an', 'psjb') ?></button>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </form>

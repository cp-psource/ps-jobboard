...
class JE_Pages_Manager
{
    ...
    function menu()
    {
        ...
        <li <?php echo je()->get('tab') == 'pages_manager' ? 'class="active"' : null ?>>
            <a href="<?php echo admin_url('edit.php?post_type=jbp_job&page=jobs-plus-menu&tab=pages_manager') ?>">
                <i class="fa fa-send"></i> <?php _e('Seitenmanager', 'psjb') ?>
            </a></li>
    <?php
    }
    ...
    function content()
    {
        ...
        <div id="page-creator">
            <div>
                <fieldset>
                    <legend style="padding-bottom: 7px"><?php _e('Job Seiten', 'psjb') ?></legend>

                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php _e('Neuen Job hinzufügen', 'psjb') ?></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button type="button" data-id="add_new_job"
                                            class="button button-primary create-page"><?php _e('Seite erstellen', 'psjb') ?></button>
                                </div>
                    ...
                    <div class="form-group">
                        <label
                            class="col-md-3 control-label"><?php _e('Jobangebote', 'psjb') ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php _e('Meine Jobs', 'psjb') ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php _e('Jobkontakt', 'psjb') ?></label>
                ...
                <fieldset>
                    <legend style="padding-bottom: 7px"><?php _e('Experten Seiten', 'psjb') ?></legend>

                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php _e('Neuen Experten hinzufügen', 'psjb') ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php _e('Expertenprofil bearbeiten', 'psjb') ?></label>
                    ...
                    <div class="form-group">
                        <label
                            class="col-md-3 control-label"><?php _e('Expertenboard', 'psjb') ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php _e('Meine Profile', 'psjb') ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php _e('Expertenkontakt', 'psjb') ?></label>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit"
                            class="button button-primary"><?php _e("Änderungen speichern", 'psjb') ?></button>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>

    ...
    function menu()
    {
        ...
        <li <?php echo je()->get('tab') == 'job_demo_data' ? 'class="active"' : null ?>>
            <a href="<?php echo admin_url('edit.php?post_type=jbp_job&page=jobs-plus-menu&tab=job_demo_data') ?>">
                <i class="dashicons dashicons-star-filled"></i> <?php _e('Jobs Demo Daten', 'psjb') ?>
            </a></li>
    <?php
    }
        ...
        <form method="post" id="job-demo-data">
            <fieldset>
                <div class="page-header" style="margin-top: 0">
                    <h4><?php _e('Erstelle Dummy-Daten für Jobs', 'psjb') ?></h4>
                </div>
                <div class="form-group">
                    <label class="col-md-3 label-control"><?php _e('Dummy Jobs Menge', 'psjb') ?></label>

                    <div class="col-md-9">
                        <input type="text" value="10" name="dummy_job_qty" class="form-control">

                        <p class="help-block"><?php _e('Anzahl der zu erstellenden Dummy-Jobs', 'psjb') ?></p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 label-control"><?php _e('Preisklasse', 'psjb') ?></label>

                    <div class="col-md-9">
                        <input type="text" value="0-2000" name="dummy_job_price_range" class="form-control">

                        <p class="help-block"><?php _e('Preisspanne', 'psjb') ?></p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-md-3 label-control"><?php _e('Fähigkeits-Tags', 'psjb') ?></label>

                    <div class="col-md-9">
                        <input type="text" value="Html5,PHP,MySQL,jQuery,Javascript,Css3,Media," name="dummy_skills"
                               class="form-control">

                        <p class="help-block"><?php _e('Demo-Fähigkeiten, durch Kommas getrennt. Wird zufällig vergeben.', 'psjb') ?></p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 label-control"><?php _e('Haben Beispieldateien', 'psjb') ?></label>

                    <div class="col-md-9">
                        <p class="help-block">
                            <input type="checkbox" checked="checked" name="have_sample">
                            <?php _e('Wenn diese Demo-Jobs Beispieldateien enthalten sollen, aktiviere dieses Kontrollkästchen.', 'psjb') ?>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-md-offset-3">
                        <button type="submit" class="btn btn-primary"><?php _e("Einreichen", 'psjb') ?></button>
                    </div>
                </div>
            </fieldset>
        </form>

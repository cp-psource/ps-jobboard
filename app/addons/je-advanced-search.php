...
class JE_Advanced_Search {
	...
	function extend_job_search_widget( $form_id ) {
        ...
        <br/>
        <label><?php _e( 'Kategorie', 'psjb' ) ?></label>
		<?php

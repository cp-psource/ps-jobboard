...
/**
 * Author: WMS N@W
 * Name: PSForum Integration
 * Description: Makellose Integration mit PSForum.
 */

/**
 * @author: DerN3rd
 */
if (!class_exists('MM_PSForum_Addon')) {
    class MM_PSForum_Addon extends IG_Request
    {
        ...
        {
            //variables init
            $this->plugin_url = plugin_dir_url(__FILE__) . 'psforum-intergration/';
            $this->plugin_path = plugin_dir_path(__FILE__) . 'psforum-intergration/';
            ...
            $this->controller = new MM_PSForum_Controller();
        }
        ...
        static function get_instance()
        {
            if (!is_object(self::$_instance)) {
                self::$_instance = new MM_PSForum_Addon();
            }
    ...
    function mm_bbi()
    {
        return MM_PSForum_Addon::get_instance();
    }
}
mm_bbi();

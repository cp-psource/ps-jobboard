 ...
 * @author:DerN3rd
 */
class MM_PSForum_Controller extends IG_Request
{
    public function __construct()
    {
        add_filter('psf_get_reply_author_link', array(&$this, 'append_message_trigger'), 10, 2);
    }
    ...
    function append_message_trigger($author_link, $r)
    {
        ...
        $author_id = psf_get_reply_author_id(psf_get_reply_id($r['post_id']));
        ...
        //$logger = new IG_Logger('file', 'message_psforum.txt');

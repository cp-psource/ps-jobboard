...
class JE_Page_Factory
{
    ...
    protected function job_listing()
    {
        ...
        if (empty($id) || !$this->page_exist($id)) {
            $args = array(
                'post_title' => sprintf(__('%s', 'psjb'), $this->jobs_obj->labels->name),
                'post_name' => sprintf(__('%s', 'psjb'), $this->jobs_obj->rewrite['slug']),
                'post_status' => 'virtual',
                'post_author' => 1,
                'post_type' => 'jbp_job',
    ...
    protected function job_contact()
    {
        ...
        if (empty($id) || !$this->page_exist($id)) {
            $args = array(
                'post_title' => sprintf(__('%s Kontakt', 'psjb'), $this->jobs_obj->labels->singular_name),
                'post_name' => sprintf(__('%s-contact', 'psjb'), $this->jobs_obj->rewrite['slug']),
                'post_status' => 'virtual',
                'post_author' => 1,
                'post_type' => 'jbp_job',
    ...
    protected function expert_listing()
    {
        ...
        if (empty($id) || !$this->page_exist($id)) {
            $args = array(
                'post_title' => sprintf(__('%s', 'psjb'), $this->expert_obj->labels->name),
                'post_name' => sprintf(__('%s', 'psjb'), $this->expert_obj->rewrite['slug']),
                'post_status' => 'virtual',
                'post_author' => 1,
                'post_type' => 'jbp_pro',
    ...
    protected function expert_contact()
    {
        ...
        if (empty($id) || !$this->page_exist($id)) {
            $args = array(
                'post_title' => sprintf(__('%s Kontakt', 'psjb'), $this->expert_obj->labels->singular_name),
                'post_name' => sprintf(__('%s-contact', 'psjb'), $this->expert_obj->rewrite['slug']),
                'post_status' => 'virtual',
                'post_author' => 1,
                'post_type' => 'jbp_pro',

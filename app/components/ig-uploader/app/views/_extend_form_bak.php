...
<div class="panel panel-default" style="margin-bottom: 5px;border-width: 1px;position:relative;">
    <div class="panel-heading">
        <strong class="hidden-xs hidden-sm"><?php _e('Hänge Medien oder andere Dateien an.', ig_uploader()->domain) ?></strong>
        <small class="hidden-md hidden-lg"><?php _e('Hänge Medien oder andere Dateien an.', ig_uploader()->domain) ?></small>
        <button type="button"
                rel="igu_popover"
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        $('#<?php echo $c_id ?> .add-file').popoverasync({
            ...
            "trigger": "click",
            "title": "<?php echo esc_js(__("Anhang hochladen",ig_uploader()->domain)) ?>",
            "html": true,

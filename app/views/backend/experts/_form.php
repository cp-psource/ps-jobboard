...
$form->open(array("attributes" => array("class" => "form-horizontal", "id" => "je-expert-form"))); ?>
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong><?php _e("Zusätzliche Informationen", 'psjb') ?></strong>
                </div>
                <div class="panel-body">
                    <div class="form-group <?php echo $model->has_error("contact_email") ? "has-error" : null ?>">
                        <?php $form->label("contact_email", array("text" => "Kontakt Email", "attributes" => array("class" => "col-lg-2 control-label"))) ?>
                        <div class="col-lg-10">
        ...
        <div class="col-md-12">
            <?php ig_uploader()->show_upload_control($model, 'portfolios', true,
                array('title' => __("Füge technische Beispiele oder zusätzliche Informationen hinzu", 'psjb'))); ?>
        </div>
        <div class="col-md-12">
            <button type="submit" class="button button-primary"><?php _e("Einreichen", 'psjb') ?></button>
        </div>
    </div>
<?php $form->close() ?>